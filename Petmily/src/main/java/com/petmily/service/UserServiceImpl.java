...
public class UserServiceImpl implements UserService {
   ...
   public User accessUser(String user_id, String user_pwd) throws Exception {
      ...
      if (user_id.equals(user.getUser_id())&&user_pwd.equals(user.getUser_pwd())) {
         return user;
   ...
   @Override
   public boolean userOverlapbyId(String user_id) throws Exception {
      User user = userDAO.queryUser(user_id);
   ...
   @Override
   public boolean userOverlapbyEmail(String user_email) throws Exception {
      User user = userDAO.queryUserByEmail(user_email);
      if(user==null)  return false;
      return true;
   } 
   ...
   public String getAccessToken (String authorize_code) {
      ...
      try {
         ...
         sb.append("&client_id=0769abb1b3231bc6b1c8297a91e4216c"); //본인이 발급받은 key

...
public class AdminServiceImpl implements AdminService {
	...
	public List<Admin> shipList(int page, PageInfo pageInfo, String search_text) throws Exception {
		int listCount=admindao.selectShipCount(search_text);
		//table에 있는 모든 row 개수
		...
		return admindao.selectShipList(startrow,search_text);
	}

	@Override
	public List<Admin> memshipList(int page, PageInfo pageInfo, String search_text) throws Exception {
		int listCount=admindao.selectMemShipCount(search_text);
		//table에 있는 모든 row 개수
		...
		return admindao.selectMemShipList(startrow,search_text);
	}

	@Override
	public List<User> alluserList(int page, PageInfo pageInfo, String mem_text) throws Exception {
		int listCount=admindao.selectalluserCount(mem_text);
		//table에 있는 모든 row 개수
		...
		return admindao.selectalluserList(startrow,mem_text);
	}

		...
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
				<div class="col-md-11 ftco-animate text-center">
					...
					<p>
						<a href="#" class="btn btn-primary mr-md-4 py-3 px-4">구독하기<span
				...
				<div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
					<div class="d-block services text-center">
						...
						<div class="media-body">
							...
							<p>구독권을 1년 이상 유지하시면 강아지 미용서비스를 제공해드립니다.</p>
							<a href="#"
								class="btn-custom d-flex align-items-center justify-content-center"><span
								class="fa fa-chevron-right"></span><i class="sr-only">Read
									more</i></a>
			...
			<div class="row d-flex no-gutters">
				<div class="col-md-5 d-flex">
					<div
						...
						style="background-image: url(${path}/resource/images/about-1.jpg);"></div>
				</div>
				<div class="col-md-7 pl-md-5 py-md-5">
					...
					<div class="row">
						...
						<div class="col-md-6 services-2 w-100 d-flex">
							...
							<div class="text pl-3">
								<h4>Produce</h4>
								<p>Petmily는 반려동물과 가족들에게 최상의 서비스를 제공합니다..</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row justify-content-center">
				<div class="col-lg-6">
					<div class="heading-section mb-5 mt-5 mt-lg-0">
						...
						<p>Petmily 구독서비스란 란 반려동물 용품을 정기구독으로 받아보실수 있는 서비스입니다.</p>
					</div>
							...
							<div class="collapse" id="collapseTwo" role="tabpanel"
								...
								<div class="card-body py-3 px-0">
									<ol>
										...
										<li>매번 따로 주문하셨던 사료 및 간식들은 정기적으로 매월 다르게 받으실수있습니다.</li>
							...
							<div class="collapse" id="collapseThree" role="tabpanel"
								...
								<div class="card-body py-3 px-0">
									<ol>
										...
										<li>Packages 외의 상품들은 스토어에서 확인하실수 있습니다.</li>
									</ol>
								</div>
							</div>
						</div>
					...
					<div class="carousel-testimony owl-carousel ftco-owl">
						<div class="item">
							<div class="testimony-wrap py-4">
								...
								<div class="text">
									<p class="mb-4">Petmily 반려동물 간식 및 사료 걱정을 덜 수 있어서 좋아요</p>
									<div class="d-flex align-items-center">
										<div class="user-img"
											style="background-image: url(${path}/resource/images/person_1.jpg)"></div>
										<div class="pl-3">
											<p class="name">윤세종</p>
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								...
								<div class="text">
									<p class="mb-4">Petmily를 이용하고부터 강아지가 너무 좋아해요</p>
									<div class="d-flex align-items-center">
										<div class="user-img"
											style="background-image: url(${path}/resource/images/person_2.jpg)"></div>
										<div class="pl-3">
											<p class="name">송욱진</p>
											<span class="position">BackEnd Developer</span>
										</div>
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								...
								<div class="text">
									...
									<div class="d-flex align-items-center">
										<div class="user-img"
											style="background-image: url(${path}/resource/images/person_3.jpg)"></div>
										<div class="pl-3">
											<p class="name">김진하</p>
											<span class="position">BackEnd Developer</span>
										</div>
						...
						<div class="text-center p-4">
							...
							<ul class="pricing-text mb-5">
								<li><span class="fa fa-check mr-2"></span>Made By Foever
									강아지 사료</li>
								<li><span class="fa fa-check mr-2"></span>Made By Song 강아지
									옷</li>
						...
						<div class="text-center p-4">
							...
							<ul class="pricing-text mb-5">
								...
								<li><span class="fa fa-check mr-2"></span>Made By SanHe 강아지
									사료</li>
								<li><span class="fa fa-check mr-2"></span>Made By Hyun 강아지
									옷</li>
							</ul>

...
<body>
	...
	<section>
		...
		<%-- 	<tr>
		<td>${user.user_nickname }님은<c:out value="${rmem.mem_grade}"
				default="현재 구독준비중" /></td>
		<br>
		<div id="message1" style="display: none;">
			<h5 style="color: red; text-align: center;">다음 결제일은
				${rmem.mem_next_date }입니다.</h5>
		</div>
		<div id="message" style="display: none;">
			<h5 style="color: red; text-align: center;">구독준비중 입니다.</h5>
		</div>
	</tr> --%>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false">
		...
		<script>
		$(function() {
			let memdate = "<c:out value='${rmem.mem_next_date }'/>";
			if (memdate == "") {
				$('#message').show();
				$('#message1').hide();
			} else {

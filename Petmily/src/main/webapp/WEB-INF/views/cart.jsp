			...
			<div class="row w-100">
				<div class="col-lg-12 col-md-12 col-12">
					...
					<p class="mb-5 text-center">
						<i class="text-info font-weight-bold">${cartList.size() }</i> 개의
						상품이 있어요.
					</p>
							...
							<c:forEach var="prod" items="${prodList }" varStatus="status">
								<tr>
									...
									<td data-th="Quantity"><input type="number"
										id="${prod.prod_num }quan" class="quan btn btn-light"
										value="${cartList[status.index].cart_amount}" min="1">
										<input type="hidden" class="total"
										value="${cartList[status.index].cart_amount * prod.prod_price}">
									</td>
									<td data-th="Price">${prod.prod_price}</td>
									<td class="actions" data-th="">
										<div class="text-right">
											<button id="${prod.prod_num }" onClick="deleteCart(this.id)"
												class="deleteBtn btn btn-white border-secondary bg-white btn-md mb-2">

...
<!-- 상단 배너-->
<section class="hero-wrap hero-wrap-2" style="background-image: url('${path}/resource/images/bg_2.png');"
...
<ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="myinfo-tab" data-bs-toggle="tab" data-bs-target="#myinfo" type="button" role="tab" aria-controls="myinfo" aria-selected="true">나의 정보</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="subscribe-tab" data-bs-toggle="tab" data-bs-target="#subscribe" type="button" role="tab" aria-controls="subscribe" aria-selected="false">구독 관리</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="order-tab" data-bs-toggle="tab" data-bs-target="#order" type="button" role="tab" aria-controls="order" aria-selected="false">주문 내역</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="delivery-tab" data-bs-toggle="tab" data-bs-target="#delivery" type="button" role="tab" aria-controls="delivery" aria-selected="false">배송지 관리</button>
    </li>
</ul>
...
<div class="tab-content" id="myTabContent">
    <!-- 나의 정보 내용 -->
    <form action="<c:url value="/mypageinfo"/>" method="get">
            ...
            <div class="item">
                <div class="table-responsive">
                    <table class="t_margin_auto width100 ds-table">
                        ...
                        <tbody>
                        <tr><td class="bg">이름</td><td id="name" name="user_name">${user.user_name }</td></tr>
                        <tr><td class="bg">아이디</td><td id="id" name="user_id">${user.user_id }</td></tr>
                        <tr><td class="bg">비밀번호</td><td id="password" name="user_pwd">${user.user_pwd }</td></tr>
                        <tr><td class="bg">닉네임</td><td id="nickname" name="user_nickname">${user.user_nickname }</td></tr>
                        <tr><td class="bg">핸드폰번호</td><td id="phone" name="user_phone">${user.user_phone }</td></tr>
                        </tbody>
                    </table>
                </div>
        ...
        <section class="ftco-section bg-white">
            <div class="table-responsive">
                <table class="t_margin_auto width100 ds-table">
                    ...
                    <tbody>
                    <tr><td>현재 구독 내역</td><td>'DB를 넣어주세요'</td></tr>
                    <tr><td>다음 구독 결제일은 'DB를 넣어주세요'입니다.</td></tr>
                    </tbody>
                </table>
            </div>
        </section>
        ...
        <section class="ftco-section bg-white">
            <div class="table-responsive">
                <table class="t_margin_auto width100 ds-table">
                    ...
                    <thead>
                    <tr><th class="title bg-light">현재 주문 내역</th><th class="title bg-light">상품 배송일</th><th class="title bg-light"></th></tr>
                    </thead>
                    <tbody>
                    <tr><td>아이디</td><td>'DB를 넣어주세요'</td><td> </td></tr>
                    <tr><td>비밀번호</td><td>'DB를 넣어주세요'</td><td> </td></tr>
                    <tr><td>닉네임</td><td>'DB를 넣어주세요'</td><td> </td></tr>
                    </tbody>
                </table>
            </div>
        </section>
...
<footer class="footer">
    <div class="container">
        ...
        <a href="mtpageinfo.html" target="_blank">petmily.com</a>
